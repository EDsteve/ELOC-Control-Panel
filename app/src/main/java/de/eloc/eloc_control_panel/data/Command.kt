...
import de.eloc.eloc_control_panel.driver.KEY_INTRUDER_IDLE_INTERVAL_S
    ...
    companion object {
        ...
        fun createSetConfigPropertyCommand(
            ...
            val rawCommand = when (property) {
                ...
                KEY_INTRUDER_IDLE_INTERVAL_S -> {
                    val intervalS = propertyValue.toDoubleOrNull()?.toInt()
                    if (intervalS == null) {
                        ""
                    } else {
                        """setConfig#cfg={"config":{"intruderCfg":{"idleIntervalS":$intervalS}}}"""
                    }
                }
