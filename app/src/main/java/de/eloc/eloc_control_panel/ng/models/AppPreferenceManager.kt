...
object AppPreferenceManager {
    private val preferences = PreferenceManager.getDefaultSharedPreferences(App.getInstance())
    ...
    fun setRangerName(name: String) {
        preferences.edit()
            .putString(PREF_RANGER_NAME, name)
            .apply()
    }

    fun getRangerName(): String =
        preferences.getString(PREF_RANGER_NAME, Constants.DEFAULT_RANGER_NAME)
            ?: Constants.DEFAULT_RANGER_NAME
